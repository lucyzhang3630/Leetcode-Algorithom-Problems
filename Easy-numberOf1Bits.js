...
// be given as signed integer type and should not affect your implementation, as the internal binary
 ...
 * @param {number} n - a positive integer
 * @return {number}
 * solution 2 extracting 1s and the length would be the answer
